	...
	public static class ConjurCredentialStoreAction extends CredentialsStoreAction {
		...
		private void addIcons() {
			IconSet.icons.addIcon(
					new Icon(ICON_CLASS + " icon-sm", "conjur-credentials/images/conjur-credential-store-sm.png",
							Icon.ICON_SMALL_STYLE, IconType.PLUGIN));
			IconSet.icons.addIcon(
					new Icon(ICON_CLASS + " icon-md", "conjur-credentials/images/conjur-credential-store-md.png",
							Icon.ICON_MEDIUM_STYLE, IconType.PLUGIN));
			IconSet.icons.addIcon(
					new Icon(ICON_CLASS + " icon-lg", "conjur-credentials/images/conjur-credential-store-lg.png",
							Icon.ICON_LARGE_STYLE, IconType.PLUGIN));
			IconSet.icons.addIcon(
					new Icon(ICON_CLASS + " icon-xlg", "conjur-credentials/images/conjur-credential-store-xlg.png",
		...
		public String getIconFileName() {
			return isVisible() ? "/plugin/conjur-credentials/images/conjur-credential-store-lg.png" : null;
		}
